<?php include_once 'includes/header.php'; ?>
    ...
    <div class="blog-container">
        ...
        <div class="blog-body">
            <div class="blog-title">
                <h1><a href="#">Comment les français sont perçu à l'étranger</a></h1>
            </div>
            <div class="blog-summary">
                <p>Globalement, selon les autres, les Français sont toujours en grève (voir <a
                            href="https://www.youtube.com/watch?v=hANtM1vJvOo">les gilets jaune</a>). On ne mettra
                    pas
                    tout sur le dos de la SNCF! D’ailleurs, cela ne date pas d’hier : l’Histoire nous le montre
                    bien,
                    les irréductibles Gaulois avaient déjà tendance à séquestrer leurs patrons et semblaient souvent
                    au
                    bord de la révolte. Mais il ne faut pas trop pousser quand même, nous ne sommes pas TOUT LE
                    TEMPS en
                    grève non, il nous arrive aussi d’être en vacances . . .
            </div>
            <div class="blog-tags">
                <ul>
                    <li><a href="#">France</a></li>
                    <li><a href="#">voyage</a></li>
                    <li><a href="#">vocally</a></li>
    ...
    <div class="blog-container">
        ...
        <div class="blog-body">
            <div class="blog-title">
                <h1><a href="comparatif.php">Comparatif Vocally vs VocalTranslator vs Google Translate </a></h1>
            </div>
            <div class="blog-summary">
            ...
            <div class="blog-tags">
                <ul>
                    ...
                    <li><a href="#">partir en vacances</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="blog-footer">
            <ul>
                ...
                <li class="comments"><a href="#">
                        ...
                        <span class="numero">8</span></a></li>
                <li class="shares"><a href="#">
                        <svg class="icon-star">
                            <use xlink:href="#icon-star"></use>
                        </svg>
                        <span class="numero">3</span></a></li>
            </ul>
        </div>
    ...
    <div class="blog-container">
        ...
        <div class="blog-body">
            <video class="video-body" controls
                   poster="http://artbees.net/themes/jupiter-demo/wp-content/uploads/2013/10/home-vid-img.jpg"
                   id="bgvid">
                <source src="http://artbees.net/themes/jupiter-demo/wp-content/uploads/2013/10/homepage.webm"
                        type="video/webm">
                <source src="http://artbees.net/themes/jupiter-demo/wp-content/uploads/2013/10/shutterstock_v3702740_4.m4v"
                        type="video/mp4">
            </video>
            <div class="blog-title">
                <h1><a href="#">Il vous partage son tour du monde</a></h1>
            </div>
            <div class="blog-tags">
                <ul>
        ...
        <div class="blog-footer">
            <ul>
                ...
                <li class="comments"><a href="#">
                        ...
                        <span class="numero">12</span></a></li>
                <li class="shares"><a href="#">
                        <svg class="icon-star">
                            <use xlink:href="#icon-star"></use>
                        </svg>
